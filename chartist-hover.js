...
(function (root, factory) {
...
})(typeof self !== "undefined" ? self : void 0, function (Chartist) {
  /**
    ...
    Chartist.plugins.hover = function (options) {
      ...
      return function hover(chart) {
        ...
        function init() {
          ...
          chart.container.addEventListener("mouseover", delegate(triggerSelector, options.onMouseEnter));
          chart.container.addEventListener("mouseout", delegate(triggerSelector, options.onMouseLeave));
        }
        /**
  ...
  })(window, document, Chartist); // Just return a value to define the module export.
